...
<head>
	...
	<title>MVC - Remote Computer Teaching</title>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">MVC - Remote Computer Teaching</h1>
			</div>
					...
					<div class="col-md-12">
						<div id="team-memebers" class="owl-carousel owl-theme">
							<div class="team-member text-center">
								<img src="img/sunil (2).jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Jeff K.</h4>
							...
							<div class="team-member text-center">
								...
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Alex M.</h4>
									<h4 class="team-member-designation">Technical Support</h4>
									<ul class="social-list">
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-twitter"></i></a></li>
							...
							<div class="team-member text-center">
								...
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Patrick C.</h4>
									<h4 class="team-member-designation">Q&A</h4>
									<ul class="social-list">
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-twitter"></i></a></li>
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-google-plus"></i></a></li>
...
<!----------------------------------------------------------Team slide 2----------------
							<div class="team-member text-center">
								...
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Solomon</h4>
									<h4 class="team-member-designation">Coo - founder</h4>
									<ul class="social-list">
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-twitter"></i></a></li>
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-google-plus"></i></a></li>
